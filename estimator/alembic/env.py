"""Alembic migration environment (async) for Postgres + pgvector."""
...
def get_database_url() -> str:
    """Resolve DATABASE_URL from the environment, falling back to Settings."""
...
def do_run_migrations(connection: Connection) -> None:
    """Configure migration context and run, recognizing the pgvector type."""
