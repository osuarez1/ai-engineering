"""Initial schema: vector extension, documents, and chunks.

Revision ID: 0001
Revises:
Create Date: 2026-07-14 03:44:00.000000
...
def upgrade() -> None:
    """Create vector extension and documents/chunks tables (no vector index)."""
...
def downgrade() -> None:
    """Drop chunks and documents; leave the vector extension installed."""
